...
import 'package:ArghyaBandyopadhyay/Pages/OtpLoginPage.dart';
import 'package:ArghyaBandyopadhyay/Pages/OtpEntryPage.dart';
    ...
    await _auth.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, [int forceResendingToken]) async {
          ...
          await Navigator.of(context)
              .push(MaterialPageRoute(builder: (_) => const OtpEntryPage()));
        },
